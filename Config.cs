...
namespace forsaken
{
    public sealed class Config : IConfig
    {
        ...
        [Description("Whether to allow item dropping during the game")]
        public bool AllowItemDrops { get; set; } = false;

        [Description("Whether to allow item pickups during the game")]
        public bool AllowItemPickups { get; set; } = false;
    }
} 